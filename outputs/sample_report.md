...
- `B02` -> `Y1` at (0, 0) size 20x16 rotated=False
- `B08` -> `Y1` at (20, 0) size 22x12 rotated=False
- `B05` -> `Y1` at (42, 0) size 24x14 rotated=False
- `B12` -> `Y1` at (20, 14) size 32x14 rotated=False
...
- `B11` -> `Y2` at (26, 16) size 30x12 rotated=True
- `B03` -> `Y3` at (0, 0) size 18x18 rotated=False
- `B04` -> `Y3` at (18, 0) size 34x10 rotated=False
- `B07` -> `Y3` at (18, 10) size 30x18 rotated=False
